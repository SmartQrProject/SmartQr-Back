...
export class CategoriesController {
  ...
  @ApiOperation({
    ...
    description:
      'Creates a new category for the restaurant menu. Requires owner authentication.',
  })
  @ApiParam({
    name: 'slug',
  ...
  @ApiResponse({
    ...
    schema: {
      example: {
        message:
          'Ya existe una categoría con el nombre "Beverages" en este restaurante',
        error: 'Conflict',
        statusCode: 409,
      },
    },
  ...
  @ApiOperation({
    ...
    description:
      'Retrieves a paginated list of categories with their products for a specific restaurant.',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Retrieves a specific category and its products for a restaurant using the category ID and restaurant slug.',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiResponse({
    ...
    schema: {
      example: {
        message:
          'Category with ID c2917676-d3d2-472a-8b7c-785f455a80ab not found in restaurant test-cafe',
        error: 'Not Found',
        statusCode: 404,
      },
    },
  ...
  @ApiOperation({
    ...
    description:
      'Updates a specific category information. You can update the name and/or sequence number.',
  })
  @ApiParam({
    name: 'slug',
    description: 'Unique restaurant identifier',
  ...
  @ApiOperation({
    ...
    description:
      'Deletes a specific category and its associated products from the restaurant menu.',
  })
  @ApiParam({
    name: 'slug',
    description: 'Unique restaurant identifier',
  ...
  @ApiOperation({
    ...
    description:
      'Updates the display order of multiple categories at once. Useful for drag and drop reordering.',
  })
  @ApiParam({
    name: 'slug',
    description: 'Unique restaurant identifier',
