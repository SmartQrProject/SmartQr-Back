...
const ApiRestaurantSuccessResponse = ApiResponse({
  status: 200,
  description: 'Restaurant successfully created',
  schema: { example: ApiRestaurantExample },
});

const ApiBadRequestResponse = ApiResponse({
  status: 400,
...
export function GetRestaurantDoc() {
  return applyDecorators(
    ...
    ApiResponse({
      ...
      schema: { example: { ...ApiRestaurantExample, categories: [{ id: '7d1e3cd8-2a0d-4a40-8b2e-4e1c9578c8f3', name: 'Beverages', products: [] }] } },
    }),
    ApiNotFoundResponse,
  );
}
    ...
    ApiResponse({
      ...
      schema: {
        ...
        properties: {
          ...
          banner: { type: 'string', example: 'https://res.cloudinary.com/dsrcokjsp/image/upload/v1747862758/lovmpbsgq7ymbzyib5zv.png' },
          address: { type: 'string', nullable: true, example: '123 Main St, Sydney' },
          phone: { type: 'string', nullable: true, example: '+61 400 000 000' },
          description: { type: 'string', nullable: true, example: 'Cozy cafe with specialty coffee and artisan pastries.' },
          tags: { type: 'array', nullable: true, items: { type: 'string' }, example: ['coffee', 'pastries', 'breakfast'] },
          trading_hours: {
            type: 'object',
            nullable: true,
            example: { mondayToFriday: { open: '08:00', close: '18:00' }, saturday: { open: '09:00', close: '15:00' }, sunday: { open: '09:00', close: '14:00' } },
          },
          ordering_times: { type: 'object', nullable: true, example: { pickup: '10-18', dinein: '11-17' } },
          categories: {
            type: 'array',
            items: {
              type: 'object',
              properties: {
                ...
                products: {
                  ...
                  items: {
                    ...
                    properties: {
                      sequenceNumber: { type: 'number', example: 1 },
                      id: { type: 'string', format: 'uuid', example: 'c1fa9f2c-bbd4-4f7a-bcb2-4f799ac3ea99' },
      ...
      examples: {
        testCafe: {
          ...
          value: {
            ...
            trading_hours: { mondayToFriday: { open: '09:00', close: '18:00' }, saturday: { open: '10:00', close: '14:00' } },
            ordering_times: { mondayToFriday: { open: '11:00', close: '22:00' }, saturday: { open: '11:00', close: '14:00' } },
          },
        },
      },
    }),
      ...
      schema: {
        ...
        items: {
          ...
          properties: {
            ...
            banner: { type: 'string', format: 'uri', example: 'https://res.cloudinary.com/dsrcokjsp/image/upload/v1748134217/banners/zj631kav9gxmqqpqxz3s.jpg' },
          },
        },
      },
    }),
