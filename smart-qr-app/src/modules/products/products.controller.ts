...
export class ProductsController {
  ...
  @ApiOperation({
    ...
    description:
      'Creates a new product in a specific category for the restaurant menu.',
  })
  @ApiParam({
    name: 'slug',
  ...
  @ApiResponse({
    ...
    schema: {
      example: {
        message:
          'Ya existe un producto con el nombre "Coca Cola" en este restaurante',
        error: 'Conflict',
        statusCode: 409,
      },
    },
  ...
  @ApiOperation({
    ...
    description:
      'Retrieves all products for a specific restaurant using its slug. Products are returned paginated and ordered by their sequence number.',
  })
  @ApiResponse({
    status: 200,
    description:
      'List of all products for the restaurant successfully retrieved',
    content: {
      'application/json': {
        example: {
          products: [
  ...
  @ApiResponse({
    ...
    schema: {
      example: {
        message: 'Restaurant test-cafe not found',
        error: 'Not Found',
        statusCode: 404,
      },
    },
  ...
  @ApiOperation({
    ...
    description:
      'Retrieves a specific product from a restaurant using the restaurant slug and product ID',
  })
  @ApiResponse({
    status: 200,
    ...
    content: {
      'application/json': {
        example: {
          id: '97ed9278-5451-4363-8bbc-c4280bfd0f02',
          name: 'Coca Cola',
          price: 2.5,
          description: 'Regular Coca Cola 355ml',
          image_url: 'https://example.com/images/coca-cola.jpg',
  ...
  @ApiResponse({
    ...
    schema: {
      example: {
        message: 'Product not found in restaurant test-cafe',
        error: 'Not Found',
        statusCode: 404,
      },
    },
  ...
  @ApiOperation({
    ...
    description:
      'Updates an existing product in the restaurant menu with the provided data',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiBody({
    ...
    examples: {
      product: {
        ...
        description: "Example of updating a product's details",
      },
    },
  })
  async update(
  ...
  @ApiOperation({
    ...
    description:
      'Removes a product from the restaurant menu. This action cannot be undone.',
  })
  @ApiResponse({
    status: 200,
    ...
    content: {
      'application/json': {
        example: {
          message:
            "Product 'Coca Cola Zero' has been deleted from restaurant 'Test Cafe'",
        },
      },
    },
  })
  ...
  @ApiParam({
    name: 'slug',
    description: 'Restaurant slug (Example: test-cafe)',
    example: 'test-cafe',
    required: true,
    type: 'string',
  })
  @ApiBody({
    ...
    examples: {
      products: {
        ...
        description:
          'Example of updating sequence numbers for multiple products',
      },
    },
  })
